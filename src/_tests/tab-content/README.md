...
![Вкладки на чистом CSS](./images/final.png 'Вкладки на чистом CSS')

![Вкладки на чистом CSS при наведении](./images/final-hover.png 'Вкладки на чистом CSS при наведении')
...
- Для вкладки JavaScript значение `js`
  Каждая ссылка имеет класс `.tab-name` и отображается как блочный элемент.
...
1. Изображение. Используйте соответствующие изображения из директории /images
...
Подключите шрифт Raleway. Для body подключите этот шрифт со следующими значениями:
...
- [селектор потомков](https://ru.hexlet.io/courses/layout-designer-basics/lessons/css-intro/theory_unit)
- [родственные селекторы и селекторы по атрибутам](https://ru.hexlet.io/courses/css-content/lessons/selectors/theory_unit)
